...
由于作者大大用的是比较早版本的URP，且Unity更新管线ApI很快，所以早期仓库内容并不能直接使用在Unity6中，且由于Unity在逐渐推崇rendergraha，早期管线API[...]
...
其次是一些修改改进，比如对于光源与摄像机方向完全垂直时（即光源在摄像机的正侧方），导致的效果突变异常，加入并暴露了衰减参数，从而达到光源中心向屏幕边缘的衰减效果
